...
const TruckIcon = ({ isActive }) => (
  <svg
    className={`w-6 h-6 transition-transform duration-300 hover:scale-110 ${
      isActive ? "text-orange-700 font-bold" : "hover:text-orange-700"
    }`}
    fill={isActive ? "currentColor" : "none"}
    stroke="currentColor"
    viewBox="0 0 24 24"
    ...
    <nav className="bg-white sticky top-0 z-50 font-sans ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-18">
          <Link
            to="/"  
            className="text-3xl font-black tracking-tighter italic uppercase"
          >
          ...
          <div className="hidden md:flex items-center space-x-5 ml-20">
            ...
            >
              <HeartIcon
                count={wishlistCount}
                isActive={activeMenu === "/wishlist"}
              />
            </ProtectedLink>

            {!user && (
              <Link to="/Account" className="hover:text-orange-700">
                <UserIcon isActive={activeMenu === "/Account"} />
              </Link>
            )}
            ...
            <ProtectedLink
              ...
              iconName="Cart"
            >
              <CartIcon count={cartCount} isActive={activeMenu === "/cart"} />
            </ProtectedLink>
            ...
            <ProtectedLink
              ...
              iconName="Orders"
            >
              <TruckIcon isActive={activeMenu === "/shipping"} />
            </ProtectedLink>
