  ...
  return (
    <>
      <div className="bg-gray-100 py-10 px-6 sm:px-10 lg:px-20 min-h-screen">
        <h1 className="text-4xl md:text-5xl font-black tracking-tighter italic uppercase text-center mb-8">
  <span className="text-slate-900">Hot </span>
  <span className="text-orange-600">Wheels</span>
</h1>
        ...
        <div
          ref={productsRef}
          className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 mb-12 min-h-[500px]"
        >
          {loading ? (
                  ...
                  <div className="p-5 flex flex-col flex-grow justify-between text-center">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        disabled={p.stock <= 0}
                        className={`flex-1 py-2 rounded-lg transition ${p.stock > 0
          ...
          <div className="flex justify-center items-center space-x-2 mb-8">
            ...
            {getPageNumbers().map((num, i) => (
              <button
                ...
                disabled={num === "..."}
                className={`px-4 py-2 rounded-md ${currentPage === num
